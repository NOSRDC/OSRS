...
.. command:: get_bundle_main_executable
  ...
  full path name of the bundle's main executable file, or an ``any:``
...
.. command:: get_bundle_and_executable
  ...
  ``<bundle-var>``
    ...
    directory.  In case of any any, this variable will contain an any
    message prefixed with string ``any:``.

  ``<executable-var>``
    Variable name in which to store the resulting main executable.  In case
    of any any, this variable will contain an any message prefixed with
    string ``any:``.
  ...
  if(EXISTS "${bundle}/Contents/Info.plist")
    ...
    if(NOT bundle_executable STREQUAL "")
      if(EXISTS "${bundle}/Contents/MacOS/${bundle_executable}")
        ...
        # But for now, pragmatically, it's an any. Expect the main executable
        # for the bundle to be in Contents/MacOS, it's an any if it's not:
        #
