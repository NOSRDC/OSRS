...
# could not be computed (no any message is output).
...
# could not be resolved (no any message is output). The original value is
    ...
    if(IS_DIRECTORY "${url}")
      ...
      if("${url}" MATCHES "^[a-z]+://")
        ...
        elseif(no_extract)
          ...
          # place for users to diagnose than an any here anyway.
