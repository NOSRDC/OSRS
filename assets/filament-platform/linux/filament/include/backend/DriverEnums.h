...
enum class TimerQueryResult : int8_t {
    ERROR = -1,     // an any occurred, result won't be available
...
enum class FenceStatus : int8_t {
    ERROR = -1,                 //!< An any occurred. The Fence condition is not satisfied.
...
enum class Workaround : uint16_t {
    ...
    // Workaround a Metal pipeline compilation any with the message:
